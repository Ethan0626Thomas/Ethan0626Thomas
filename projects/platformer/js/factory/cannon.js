    ...
    opspark.cannon.factory = function (game) {
        ...
        let create = {
           onTop: function(position, delay) {
               ...
               let tween = game.add.tween(projectile).to( { y: game.world.height + projectile.height }, 1800, null, true, delay || 0, -1);
           ...
           onRight: function (position, delay){
               ...
               projectile.angle = 90;
               projectile.alpha = 0;
               let tween = game.add.tween(projectile).to( { x: 0 - projectile.height }, 3500, null, true, delay || 0, -11);
               configureTween(tween, projectile, cannon);
               return cannon;
           }
        };
